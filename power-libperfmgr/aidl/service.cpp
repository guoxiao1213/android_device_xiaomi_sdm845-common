...
#define LOG_TAG "android.hardware.power-service.xiaomi-sdm710-libperfmgr"
...
int main() {
    ...
    LOG(INFO) << "Xiaomi sdm710 Power HAL AIDL Service with Extension is starting with config: "
              << config_path;
    ...
    LOG(INFO) << "Xiaomi sdm710 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Xiaomi sdm710 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
